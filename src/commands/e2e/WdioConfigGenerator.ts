...
export class WdioConfigGenerator {
    ...
    constructor(plugins: string[], baseUrl: string, browser: string, timeout: number, workingDir: string) {
    ...
    public generateWdioConfig(): void {
        this.plugins.forEach((plugin) => {
            ...
            const config = new ConfigTemplate(e2eFolder, this.browser, this.baseUrl, this.timeout);
