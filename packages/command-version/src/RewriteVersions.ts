import {ICommand, ICommandParameters} from '@cplace-cli/core';
import {AbstractReposCommand, IReposDescriptor} from '@cplace-cli/command-repos';
import * as path from 'path';
import {fs, readFileAsync, writeFileAsync} from '@cplace-cli/core';
import {Global} from '@cplace-cli/core';
import {CplaceVersion} from '@cplace-cli/helpers';
