...
import { ICommandParameters, fs, readdirAsync, writeFileAsync } from '@cplace-cli/core';
import { Repository } from '@cplace-cli/git-utils';
import { IReposDescriptor } from '../models.js';
import * as path from 'path';

// Utility function to enforce newline endings
function enforceNewline(text: string): string {
    return text.replace(/\r\n?/g, '\n');
}
...
export class BranchRepos extends AbstractReposCommand {
    ...
    public prepareAndMayExecute(params: ICommandParameters): boolean {
        // Get branch name from the Commander.js parsed parameters
