import {assertVoid, basicTestSetupData, catParentReposJson, testWith} from '../../../../test/helpers/remoteRepositories';
import {IReposDescriptor} from '../models.js';
import {IReposValidationResult, ValidateBranches} from '../subcommands/validate-branches.js';
import {ICommandParameters, Global} from '@cplace-cli/core';
import {enforceNewline} from '@cplace-cli/core';
